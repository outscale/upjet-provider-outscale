...
import (
	...
	v1alpha1 "github.com/outscale-vbr/upjet-provider-outscale/apis/route/v1alpha1"
)
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	r := managed.NewReconciler(mgr,
		...
		managed.WithExternalConnecter(tjcontroller.NewConnector(mgr.GetClient(), o.WorkspaceStore, o.SetupFn, o.Provider.Resources["outscale_route"],
